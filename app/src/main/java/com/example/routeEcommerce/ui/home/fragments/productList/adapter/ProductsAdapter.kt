package com.example.routeEcommerce.ui.home.fragments.productList.adapter
    ...
    inner class ViewHolder(val itemProductBinding: ItemProductBinding) :
        ...
        fun bind(product: Product?) {
            ...
            if (product?.priceAfterDiscount != null) {
                ...
                itemProductBinding.productOldPrice.text = "EGP ${"%,d".format(product.price)}"
                ...
                itemProductBinding.productPrice.text = "EGP ${"%,d".format(product?.price)}"
